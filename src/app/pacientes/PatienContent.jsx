  ...
  return (
    <>
      <div className="flex justify-between my-4">
        ...
        />
        <button onClick={() => router.push("/pacientes/new")} className="flex items-center justify-between bg-blue-500 text-white gap-2 px-3 py-2 rounded hover:bg-blue-600 cursor-pointer">
          Nuevo Paciente
          <IoMdAdd />
        </button>
      </div>
